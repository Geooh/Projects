...
public class Queens {
    ...
    public void clearBoard(){
        ...
        // Clears the board.
        // Precondition:  None.
        // Post condition:  Sets all squares to EMPTY
        // --------------------------------------------------
        for(int i = 0; i < BOARD_SIZE; i++){
            for(int j = 0; j < BOARD_SIZE; j++){
                // setting all squares to EMPTY
                board[BOARD_SIZE][BOARD_SIZE] = EMPTY;
            }
        }
    }  // end clearBoard
    ...
    public void displayBoard(){
        ...
        // Displays the board.
        // Precondition:  None.
        // Post condition:  Board is written to standard
    ...
    public boolean placeQueens(int column) {
        ...
        // Post condition:  If a solution is found, each
    ...
    private void setQueen(int row, int column) {
        ...
        // column.
        // Precondition:  None.
        // Post condition:  Sets the square on the board in a
    ...
    private boolean isUnderAttack(int row, int column) {
        ...
        // queen.
        // Post condition:  If the designated square is under
